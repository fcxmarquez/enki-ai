...
export const NavBar = () => {
  ...
  return (
    <header className="align-center fixed top-0 z-10 flex h-12 w-screen items-center justify-between border-b border-gray-300 bg-header-default">
      ...
      <Box className="absolute flex w-full justify-center">
        <h1>EnkiAI</h1>
      </Box>
    </header>
  );
