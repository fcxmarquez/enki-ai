  ...
  const BreakpointCard = ({ 
    ...
    <div style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
        <h3 style={{ fontSize: '18px', fontWeight: '600', marginRight: '12px', textTransform: 'capitalize' }}>
          {name}
        </h3>
        <code style={{ 
          fontSize: '14px', 
      ...
      <div style={{ marginBottom: '16px' }}>
        <h4 style={{ fontSize: '14px', fontWeight: '500', marginBottom: '8px' }}>Common Use Cases:</h4>
  ...
  return (
    <div style={{ padding: '24px', fontFamily: 'system-ui, sans-serif', maxWidth: '800px' }}>
      ...
      <p style={{ fontSize: '16px', color: '#666', marginBottom: '32px' }}>
        Our responsive design system uses these breakpoints to ensure optimal user experience across all device sizes.
      </p>
      ...
      <div style={{ marginTop: '32px', padding: '16px', backgroundColor: '#e8f4f8', borderRadius: '8px' }}>
        <h3 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '8px' }}>
          💡 Implementation Tips
        </h3>
        <ul style={{ fontSize: '14px', color: '#555', paddingLeft: '20px' }}>
          <li style={{ marginBottom: '4px' }}>Use mobile-first approach with min-width media queries</li>
          <li style={{ marginBottom: '4px' }}>Test layouts at breakpoint boundaries (±1px)</li>
          <li style={{ marginBottom: '4px' }}>Consider content hierarchy changes at each breakpoint</li>
          <li style={{ marginBottom: '4px' }}>Ensure touch targets are at least 44px on mobile</li>
        </ul>
      </div>
    </div>
  );
...
const meta: Meta<typeof Breakpoints> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Responsive breakpoint system defining how the EnkiAI interface adapts across different screen sizes and devices.',
      },
    },
  },
};
