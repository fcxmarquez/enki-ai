...
const Overview = () => {
  ...
  const StatCard = ({ 
    ...
    <div style={{ textAlign: 'center', padding: '16px' }}>
      ...
      <div style={{ fontSize: '16px', fontWeight: '500', marginBottom: '4px' }}>{label}</div>
    ...
    <div style={{ fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          A comprehensive design system that ensures consistency, accessibility, and exceptional user experience across the EnkiAI platform.
        </p>
      </div>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '14px', color: '#666', lineHeight: '1.6' }}>
                Every component is built with accessibility in mind, ensuring inclusive experiences for all users regardless of their abilities.
              </p>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '14px', color: '#666', lineHeight: '1.6' }}>
                Unified visual language and interaction patterns create predictable and intuitive user experiences across the platform.
              </p>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '14px', color: '#666', lineHeight: '1.6' }}>
                Optimized components and efficient styling ensure fast loading times and smooth interactions on all devices.
              </p>
            </div>
          </div>
        </div>
      ...
      <div style={{ 
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ 
            ...
            Ready to build with the EnkiAI design system? Explore each section to understand the components, 
            patterns, and guidelines that will help you create consistent and beautiful user interfaces.
          </p>
...
const meta: Meta<typeof Overview> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Welcome to the EnkiAI Design System - a comprehensive guide to building consistent, accessible, and beautiful user interfaces.',
      },
    },
  },
};
